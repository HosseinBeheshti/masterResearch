...
final_result_s40.error_lp = mean(simulaiton_result.error_lp);
final_result_s40.error_cp = mean(simulaiton_result.error_cp);
final_result_s40.error_acp = mean(simulaiton_result.error_acp);
