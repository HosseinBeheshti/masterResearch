...
close all;
hold on;
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), final_result.final_result_s10.time_lp, ...
    'DisplayName', 'LP', 'Marker', '*', 'LineStyle', '-.', 'Color', [0 0.5 0], 'LineWidth', 1.5);
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), final_result.final_result_s10.time_cp, ...
    'DisplayName', 'CP', 'Marker', 'diamond', 'LineStyle', '--', 'Color', [1 0 0], 'LineWidth', 1.5);
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), final_result.final_result_s10.time_acp, ...
    'DisplayName', 'Our algorithm', 'Marker', 'square', 'Color', [0 0 1], 'LineWidth', 1.5);
legend('LP', 'CP', 'Our algorithm');
