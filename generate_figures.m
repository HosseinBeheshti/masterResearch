...
close all;
hold on;
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), 10 * log10(final_result.final_result_s20.error_lp), ...
    'DisplayName', 'LP', 'Marker', '*', 'LineStyle', '-.', 'Color', [0 0.5 0], 'LineWidth', 1.5);
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), 10 * log10(final_result.final_result_s20.error_cp), ...
...
plot(((0:(final_result.total_itr_number - 1)) * final_result.step_m + final_result.min_m), 10 * log10(final_result.final_result_s40.error_acp), ...
