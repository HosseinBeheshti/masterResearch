...
for mcr = 1:max_mcr
    ...
    FileName = [temp_name, num2str(mcr)];
    save(FileName);
...
FileName = [temp_name, '*.mat'];
delete(FileName);
SimName = ['simulation_result', '_N=', num2str(N), '_n=', num2str(n), '_s=', num2str(s), '_T=', num2str(T), '_montecarlo_itr=', num2str(max_mcr)];
